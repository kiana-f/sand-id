...
//  SandID
//
//  Created by Kiana Fithian on 3/9/22.
//
...
private class PopUpWindowView: UIView {
	...
	init() {
		...
		popupTitle.backgroundColor = UIColor.black.withAlphaComponent(0.6)
		...
		popupButton.backgroundColor = UIColor.black.withAlphaComponent(0.6)
		...
		NSLayoutConstraint.activate([
			popupText.heightAnchor.constraint(greaterThanOrEqualToConstant: 100),
